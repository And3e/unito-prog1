...
int main(void) {
  ...
  // Quale caratteristica hanno le dimensioni dei tipi puntatore?
  // Perché?

  // Hanno tutti la stessa dimensione (8)
  // Perché contengono soltanto l'indirizzo della cella di memoria, non importa quanto sia grande la cella
